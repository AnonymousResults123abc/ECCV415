...
class BiConv2d(nn.Conv2d):
    ...
    def __init__(self, *kargs, **kwargs):
        super(BiConv2d, self).__init__(*kargs, **kwargs)
        self.scale = nn.Parameter(torch.rand(self.weight.size(0), 1, 1), requires_grad=True)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.binary_conv = BiConv2d(inplanes, planes, kernel_size=3, padding=1, stride=stride,bias=False)
